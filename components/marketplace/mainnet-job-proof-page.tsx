      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <Card className="marketplace-surface"><CardHeader><CardTitle>Measured result</CardTitle></CardHeader><CardContent><dl className="space-y-3 text-sm">
          {[
            ...
            ["Budget raw", proof.budgetRaw], ["Duration", `${proof.durationSeconds} seconds`],
          ...
          <div className="grid gap-1 border-b border-white/10 pb-3 sm:grid-cols-[9rem_1fr]"><dt className="text-zinc-500">Payment token</dt><dd><PaymentTokenIdentity address={proof.token} chainId={56} /></dd></div>
