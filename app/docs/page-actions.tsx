...
function OpenAiLogo() {
  return (
    <svg aria-hidden="true" className="size-3.5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
function ClaudeLogo() {
  return (
    <svg aria-hidden="true" className="size-3.5 text-[#D97757]" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
