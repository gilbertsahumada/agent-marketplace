      ...
      <Card className="mt-8">
        ...
        <CardContent className="space-y-4 text-sm">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild variant="outline"><a href="https://bscscan.com/address/0xEa4DAa3100A767e86FDed867729ae7446476EBA6" rel="noreferrer" target="_blank">Commerce on explorer<ExternalLink /></a></Button>
          </div>
        </CardContent>
      </Card>
    </main>
