...
export const HOSTED_SELLERS: readonly HostedSellerManifestEntry[] = [
  ...
  { slug: "rebalance", agentId: null, endpoint: `${HOSTED_SELLER_ORIGIN}/rebalance`, messageUrl: `${HOSTED_SELLER_ORIGIN}/api/sellers/rebalance/a2a`, category: "rebalancing" },
  { slug: "yield", agentId: null, endpoint: `${HOSTED_SELLER_ORIGIN}/yield`, messageUrl: `${HOSTED_SELLER_ORIGIN}/api/sellers/yield/a2a`, category: "yield_optimisation" },
  { slug: "loan-health", agentId: null, endpoint: `${HOSTED_SELLER_ORIGIN}/loan-health`, messageUrl: `${HOSTED_SELLER_ORIGIN}/api/sellers/loan-health/a2a`, category: "health_factor_monitoring" },
];
