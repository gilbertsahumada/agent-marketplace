...
export interface Env {
  ...
  CATALOG_V2_READS_ENABLED?: string;
  CATALOG_V2_WRITES_ENABLED?: string;
  CATALOG_RESPONSE_CACHE_SECONDS?: string;
  ...
  CATALOG_A2A_TIMEOUT_MS?: string;
  CATALOG_MCP_TIMEOUT_MS?: string;
  CATALOG_ERC8183_TIMEOUT_MS?: string;
  CATALOG_PRIORITY_REFRESH_MINUTES?: string;
  CATALOG_A2A_REFRESH_MINUTES?: string;
  CATALOG_MCP_REFRESH_MINUTES?: string;
  CATALOG_ERC8183_REFRESH_MINUTES?: string;
  CATALOG_FAILURE_BACKOFF_MINUTES?: string;
